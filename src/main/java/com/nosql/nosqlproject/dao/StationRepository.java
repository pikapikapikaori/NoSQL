...
match
    (a:Line)
return a.name, a.direction, count(a.route_up_or_round) order by count(a.route_up_or_round)
union all
return a.name, a.direction, count(a.route_down) order by count(a.route_down)
    """)
